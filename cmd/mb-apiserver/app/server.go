...
import (
	"github.com/MmringZee/practise-miniblog/cmd/mb-apiserver/app/options"
	"github.com/MmringZee/practise-miniblog/pkg/version"
...
• High-quality code.`,
	...
	// 初始化配置函数
	// 每个命令运行时调用时, 都会调用 cmd/mb-apiserver/app/config.go 的 onInitialize 函数
